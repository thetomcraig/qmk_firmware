...
[DOX_BASE] = LAYOUT_ergodox(
  ...
  /* bottom row */                                                      KC_RGUI, KC_RALT,  KC_RCTRL,    KC_RALT,     KC_RCTRL,
...
[DOX_LYR1] = LAYOUT_ergodox(
  ...
  /* top row */                  KC_GRV,  TMUX_1,  TMUX_2,  TMUX_3,  TMUX_4,      TMUX_5,  _______,
                                 _______, WIN_TL,  WIN_T,   WIN_TR,   TMUX_SWAP_L, TMUX_SWAP_R,
  ...
  /* index, large top key */                        _______,
                                                             TMUX_C,  TMUX_CYC,TMUX_SWAP_L, TMUX_SWAP_R, TMUX_P,      _______,
